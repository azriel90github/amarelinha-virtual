				...
				<div className="max-w-3xl w-full px-6 text-center space-y-10">
					...
					<div className="w-full">
						...
						<div className="flex justify-center flex-wrap gap-4 w-full">
							...
							<button
								onClick={menuPage}
								className="accountButton border-2 border-colorInput flex items-center justify-between w-80 bg-colorFundo px-8 py-4 rounded-full shadow-shape text-buttonColor hover:bg-colorHover hover:text-zinc-200 transition duration-400 font-medium text-xl"
							>
