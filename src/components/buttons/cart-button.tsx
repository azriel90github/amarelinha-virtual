...
export function CartButton() {
  ...
  return (
    // biome-ignore lint/a11y/useButtonType: <explanation>
		<button
      onClick={OrderPage}
      className="cartButton flex flex-1 flex-row w-72 hover:bg-buttonColor hover:text-zinc-200 shadow-shape bg-colorHover transition duration-400 text-zinc-200 rounded-2xl px-7 py-3.5"
    >
